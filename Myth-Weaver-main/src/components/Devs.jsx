  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 bg-backgroundColor ">
      ...
      <div className=" flex flex-col lg:flex-row gap-5 justify-center py-4 my-8">
        ...
        <Devs img={img2} title="Aman" username="@amanhusain988" desc="I'm Aman Husain. I suggested the UI and identified the functions that would help make this product. I'm not a UI/UX designer; I just try helped her to achieve the best outcome." />
